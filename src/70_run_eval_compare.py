...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='70_run_eval_compare.py', description='Run eval compare between experiments.',
    ...
    for experiment in tqdm(experiments):
        ...
        subprocess.run(['python', '71_eval_compare.py', mpeg_output_dir, folding_output_dir], check=True)
